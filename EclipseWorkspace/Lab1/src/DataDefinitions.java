...
class Publisher{
  ...
  // the constructor 
  Publisher(String pname, String country, int year){
    this.pname = pname;
...
class ExamplesBooks{
  ...
  Publisher longhorn = new Publisher("Longhorn Publishers", "Kenya", 1998);
  Book beaches = new Book("Beaches", this.pat, this.longhorn, 20);
}
